...
def show_reviews(quality):
    print()
    print("Your Rating:     {:f}".format(quality.rating))
    print("Your Review:     " + quality.review)
    print("Total Reviews:   " + quality.reviewNum)
...
def main():
    ...
    while True:
        ...
        ratingPrompt = int(input("Review the product using 1 through 5: "))
        reviewPrompt = input("Review the product: ")

        rating = Quality(ratingPrompt, reviewPrompt, str(12))
        show_reviews(rating)
